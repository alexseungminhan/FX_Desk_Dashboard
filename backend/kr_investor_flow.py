...
값은 네이버가 주는 원본 단위 그대로 — 코스피·코스닥은 순매수 대금(백만원),
선물은 순매수 수량(계약)이다. 억/조 환산은 표시하는 쪽에서 한다. 어느 쪽이든
개인 + 외국인 + 기관계 + 기타법인 = 0 이 성립하는 순매수 값이다.
"""
...
MARKETS = {
    "01": {"key": "kospi", "label": "코스피", "unit": "krw"},
    "02": {"key": "kosdaq", "label": "코스닥", "unit": "krw"},
